nested_test("validations") do
    ...
    nested_test("bounds") do
        ...
        nested_test("range") do
            ...
            @test_throws chomp("""
                               ArgumentError: range low limit foo.minimum: 1
    ...
    nested_test("color") do
        ...
        @test_throws "ArgumentError: invalid foo_color: Oobleck" validate_is_color(context, "Oobleck")
    end
    ...
    nested_test("dict") do
        ...
        nested_test("empty") do
            ...
            empty!(dict)
            @test_throws "ArgumentError: empty dict foo.bar" validate_dict_is_not_empty(context, "bar", dict)
        end
        ...
        nested_test("entries") do
            ...
            @test_throws chomp("""
                               ArgumentError: too high foo.baz[bar]: 1
                               is not below: 1
                               """) begin
                validate_dict_entries(context, "baz", dict) do key, value
    ...
    nested_test("vector") do
        ...
        nested_test("length") do
            ...
            @test_throws chomp("""
                               ArgumentError: invalid length of foo.bar: 2
        ...
        nested_test("entries") do
            ...
            @test_throws chomp("""
                               ArgumentError: too high foo.bar[2]: 1
                               is not below: 1
                               """) begin
                validate_vector_entries(context, "bar", vector) do index, value
                    return validate_is_below(context, value, 1)
    ...
    nested_test("matrix") do
        ...
        nested_test("size") do
            ...
            @test_throws chomp("""
                               ArgumentError: invalid size of foo.bar: (2, 3)
        ...
        nested_test("empty") do
            ...
            @test_throws "ArgumentError: empty matrix foo.bar size: (0, 3)" validate_matrix_is_not_empty(
                context,
                "bar",
                matrix,
            )
        ...
        nested_test("entries") do
            ...
            @test_throws chomp("""
                               ArgumentError: too low foo.bar[2, 3]: 0
                               is not above: 0
                               """) validate_matrix_entries(context, "bar", matrix) do row, column, value
